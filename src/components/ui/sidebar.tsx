...
>(
  (
          ...
          >
            ...
            <div className="flex h-full w-full flex-col">
              <SheetHeader className="p-4 border-b">
                  <SheetTitle className="text-xl">Vibespace</SheetTitle>
              </SheetHeader>
              {children}
            </div>
          </SheetContent>
    ...
    return (
      <div
        ref={ref}
        className="group peer hidden md:block text-foreground fixed inset-y-0 z-30"
        data-state={state}
      ...
      >
        <div
          data-sidebar="sidebar"
          className={cn(
            "flex h-full flex-col bg-background border-r transition-[width] duration-300",
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center gap-3 overflow-hidden rounded-md p-2 text-left text-sm outline-none ring-sidebar-ring transition-all hover:bg-secondary focus-visible:ring-2 active:bg-secondary disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-secondary data-[active=true]:font-semibold",
  {
    variants: {
      variant: {
        default: "hover:bg-secondary",
        outline:
          "bg-background shadow-[0_0_0_1px_hsl(var(--border))] hover:bg-secondary hover:shadow-[0_0_0_1px_hsl(var(--accent))]",
      },
      size: {
