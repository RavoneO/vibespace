...
const analytics = typeof window !== 'undefined' && firebaseConfig.measurementId ? isSupported().then(yes => yes ? getAnalytics(app) : null) : Promise.resolve(null);
