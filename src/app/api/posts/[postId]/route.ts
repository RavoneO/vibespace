...
import { deletePost, updatePostAs, updatePostService, addComment as addCommentService } from '@/services';
...
export async function PATCH(
    ...
    try {
        ...
        const updatedPost = await updatePostService(postId, { caption });
...
export async function POST(
    ...
    try {
        ...
        console.error('Error processing action for post:', error);
        return NextResponse.json({ error: 'Internal Server Error' }, { status: 500 });
    }
}
